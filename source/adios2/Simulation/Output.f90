...
100 format(6(1x,es14.7))
  ...
  subroutine phaseoutBB_adios2(Bpts, Nplocal, iturn, idbunch, itic, iseedinit,close2g)
    implicit none
    include 'mpif.h'
    ...
    call adios2_phaseout(Bpts, idbunch, itic, iseedinit, close2g);
    !write(*,*)Nplocal,iturn,itic,iseedinit,close2g(1),close2g(2)
    !write(*,*)Bpts(1:6,1:Nplocal)
  end subroutine phaseoutBB_adios2

  subroutine ptclout_Output_adios2(Bpts,myid,iturn,idbunch,npOut,sampleInd)
    implicit none
    include 'mpif.h'
    ...
    if (myid == -1) then 
       if (iturn .le.10) then
          write (*,*) myid, idbunch, iturn, tmppts(1:6,1) 
       endif
    endif
    call adios2_writePtlData(idbunch, iturn, tmppts);


    deallocate(tmppts)
  end subroutine ptclout_Output_adios2
